...
## 현재 구현 상태 체크 (2026-04 기준)

- [x] v0 로그인 (Google OAuth + 이메일 Verify Code) — 구현 완료.
- [x] v1 책 신청 + 독후감 — 구현 완료 (14, 15 참조).
- [x] v1+ 합산 주문서 / 마감 잠금 / 도착·수령 — 구현 완료 (14 참조).
- [x] 월별 예산 + 나눔 — 구현 완료 (13 참조).
- [x] 책 카탈로그 + 중복 체크 + 제한풀기 v1 — 구현 완료 (08 참조).
- [x] 가입 신청/승인/역할 변경 — 구현 완료 (10 참조).
- [x] DEVELOPER 전역 역할 + 화이트리스트 — 구현 완료 (11 참조).
- [x] 동적 설정(AppConfig) v1 — 구현 완료 (16 참조).
- [◐] 알림(NotificationService) — 추상화 v1(Logging)만, Slack v2 미착수 (12 참조).
- [ ] 벌점/포인트 — 미착수.
- [ ] 도서 대여 이력 — 미착수.
